...
module.exports = function (webreference, assetType) {
    assetType = (assetType != null) ? assetType : 'Page';
    return new Promise(function (resolve, reject) {
        authenticate().then(function (ticket) {
            request({
                ...
                url: config.host + '/cs/REST/sites/www-cars-com/types/' + assetType + '/search',
                qs: {
                    multiticket: ticket,
